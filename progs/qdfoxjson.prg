...
*
* VES	Abr 14, 2012	1.5		- Correccion en el manejo de CR y LF en _encodeString y _decodeString (Juan Pablo Martín P, Espana)
 ...
 *******************************************
 ...
 HIDDEN PROCEDURE _Limpar(pcJSON)
 	*Everton Silva
	*31/03/2016
	*Retira ',' que estão dentro de um string e adiciona '.'
	*Retira "'" que estão dentro de um string e adiciona '|'
	*04/02/2020
	*Retira "[" que estão dentro de um string e adiciona '|'
	*Retira "]" que estão dentro de um string e adiciona '|'
